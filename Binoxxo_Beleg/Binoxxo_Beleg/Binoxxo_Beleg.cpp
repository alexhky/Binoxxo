...
// Binoxxo_Beleg.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CBinoxxoBelegApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CBinoxxoBelegApp-Erstellung

CBinoxxoBelegApp::CBinoxxoBelegApp()
{
...
// Das einzige CBinoxxoBelegApp-Objekt

CBinoxxoBelegApp theApp;


// CBinoxxoBelegApp-Initialisierung

BOOL CBinoxxoBelegApp::InitInstance()
{
